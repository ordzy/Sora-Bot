...
module.exports = function (message) {
    const responses = [
        {
            trigger: ["subs don't work", "subs are not working", "subtitles don't work", "subtitles aren't working", "subtitles not working", "no subtitles", "missing subtitles", "can't see subtitles", "subtitle issue", "subtitle problem", "subs missing", "subs not showing", "subtitles not showing", "subtitles broken", "subs broken", "where are the subtitles", "how to enable subtitles", "SDW Sora", "can't get subtitles to work", "subtitle error"],
